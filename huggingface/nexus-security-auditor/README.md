...
Red/Blue team security audit with CVE scanning and OWASP analysis
...
Place the SKILL.md file in `.claude/skills/nexus-security-auditor/SKILL.md` and the agent
